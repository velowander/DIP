...
public class SimpleMapView extends View {
    ...
    //modified, based on http://stackoverflow.com/questions/5743328/image-in-canvas-with-touch-events
    ...
    private void loadImage() {
        mImage = getResources().getDrawable(R.drawable.dt_kameramuseum_plech_museumsplan_2013);
